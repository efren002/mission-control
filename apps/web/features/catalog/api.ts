...
export interface RunInvocation { id: string; agent_id: string; agent_name: string; purpose: string; status: string; provider: "codex" | "claude" | null; model: string | null; attempt: number; fallback_from_provider: "codex" | "claude" | null; routing_reason: string | null; duration_ms: number | null; input_tokens: number | null; cached_input_tokens: number | null; output_tokens: number | null; total_tokens: number | null; input_excerpt: string | null; output_excerpt: string | null; error: string | null; created_at: string; updated_at: string }
...
export interface AgentInvocation { id: string; agent_id: string; run_id: string | null; task_id: string | null; purpose: string; status: string; provider: "codex" | "claude" | null; model: string | null; attempt: number; fallback_from_provider: "codex" | "claude" | null; routing_reason: string | null; duration_ms: number | null; input_tokens: number | null; cached_input_tokens: number | null; output_tokens: number | null; total_tokens: number | null; input_excerpt: string | null; output_excerpt: string | null; error: string | null; created_at: string }
