...
export interface RunDetail extends Run { tasks: Task[]; events: RunEvent[]; invocations: RunInvocation[]; approvals: RunApproval[]; verification_criteria: VerificationCriterion[]; verification_evidence: VerificationEvidence[]; failure_category?: "rate_limited" | "provider_connection" | "provider_process" | "runtime_incompatible" | "verification_failed" | "unknown" | null; failure_message?: string | null; failure_retryable?: boolean }
