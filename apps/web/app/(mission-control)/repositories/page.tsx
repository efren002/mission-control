...
export default function RepositoriesPage() {
  ...
  const copyPath = async (repository: Repository) => {
    try {
      ...
      setMessage(`Path copied: ${repository.path}`);
      setError("");
    } catch {
